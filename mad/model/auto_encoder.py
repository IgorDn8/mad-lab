...
class AutoEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        *args, **kwargs
        ...
        self.pos_token_embs = nn.Embedding(max_length, dim)
        ...
        #print(self.dec_position_embeds.shape)
        self.drop= nn.Dropout(embed_drop_rate)
    ...
    #     position_ids = torch.arange(seqlen, dtype=torch.long, device = input_embeds.device).unsqueeze(0)
    #     pos_embs = self.pos_token_embs(position_ids)
    ...
    #     # import sys
    #     # sys.exit(0)
    #     return self.drop_embed(input_embeds+pos_embs)
    ...
    def encode(self,
        ...
        x = self.drop(input_embeds+pos_embs)
    ...
    def decode(self,
        ...
        #print(self.dec_position_embeds.shape)
        x = encoding.unsqueeze(1) + self.pos_token_embs(position_ids) # B 1 C + 1 T C -> B T C
        #print(x.shape)
        #import sys
        #sys.exit(0)
